...
const homeEnvVar = "SCAFFOLD_HOME"

var (
	flagDebug   bool
	globalUsage = `The Scaffold pack repository plugin.
`
)
...
func newRootCmd(out io.Writer, in io.Reader) *cobra.Command {
	cmd := &cobra.Command{
		Use:          "pack-repo",
		Short:        "the Scaffold pack repository plugin",
		Long:         globalUsage,
		SilenceUsage: true,
...
func homePath() string {
	...
	return filepath.Join(homeEnvPath, ".scaffold")
}
